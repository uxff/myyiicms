		...
		<div class="user_right">
			<div class="base_box clear">
				...
				<ul class="base_info">
					...
					<li><label><?php echo Yii::t('model','addtime');?>：</label><span><?php echo $profile->addtime?date('Y-m-d H:i:s', $profile->addtime):'您这是首次登录哦~';?></span></li>
					...
					<li><label><?php echo Yii::t('model','last_login_time');?>：</label><span><?php echo $profile->last_login_time?date('Y-m-d H:i:s', $profile->last_login_time):'您这是首次登录哦~';?></span></li>
